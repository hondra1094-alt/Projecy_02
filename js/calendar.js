...
//creat a fucntion that returns the correct timeslots
...
const renderCalendar = () => {
    ...
    for (let i = 0; i < firstDayOfMonth; i++){
        ...
        emptyCell.className = "calendary-Empty";
...
const renderTimeSlots = () => {
    ...
    for(let i = 0; i < slots.length; i++){
        ...
        //disable any slots already bookey
...
if(bookingForm){
    bookingForm.addEventListener("submit", (event) => {
        ...
        if(bookedAppointments[selectedDate.key].includes(timeValue)){
            bookingMessage.textContent = "The time was just take. Please choose another.";
            bookingMessage.className = "booking-message error";
            renderTimeSlots();
            return;
        };
        ...
        bookedMessage.textContent = `${nameValue}, your ${serviceValue} appointment is booked for ${formatReadableDate(
            selectedDate.year,
            selectedDate.month,
            selectedDate.day
        )} at $ ${timeValue}`;
